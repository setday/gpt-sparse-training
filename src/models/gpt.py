...
from extras.transformer_layers import CausalSelfAttention
from extras.casual_layers import LayerNorm, MLP
...
class GPT(nn.Module):
    ...
    def __init__(self, config, sparsity_ratio = 0.0, sparsity_type: Optional[SparsityType] = None, sparsity_scale: Optional[SparsityScale] = None, mode = "all", custom_slice=None):
        super().__init__()
