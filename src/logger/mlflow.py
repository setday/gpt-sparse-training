...
class MLFlowWriter:
    """
    Class for experiment tracking via ML Flow.

    See https://mlflow.org/docs/3.3.1/.
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        try:
            ...
            if mode == "offline":
                mlflow.set_tracking_uri("file:///" + kwargs.get("offline_dir", "tmp"))
            else:
            ...
            logger.warning("For use mlflow install it via \n\t pip install wandb")
    ...
    def add_checkpoint(self, checkpoint_path, save_dir):
        ...
        """
        self.mlflow.log_artifact(checkpoint_path, save_dir)
    ...
    def add_image(self, image_name, image):
        ...
        self.mlflow.log_image(
            self.mlflow.Image(image), key=self._object_name(image_name), step=self.step
        )
    ...
    def add_table(self, table_name, table: pd.DataFrame):
        ...
        self.mlflow.log_table(
            table,
            f"{self.step}_{self._object_name(table_name)}.json",
        )
